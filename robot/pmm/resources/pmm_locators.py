...
pmm_lex_locators = {
    ...
    "bulk_service_delivery_locators": {
        ...
        "select_bsdt_value" : "//lightning-base-combobox-item/descendant::span[contains(@class,'slds-listbox__option-text')]/lightning-base-combobox-formatted-text[@class='slds-truncate' and @title='{}']",
