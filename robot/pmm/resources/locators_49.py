...
pmm_lex_locators["new_record"]["button"]="//button[contains(@class, 'slds-button') and @title = '{}']"
pmm_lex_locators["new_record"]["error_message"]="//div[@class='pageLevelErrors']//ul[@class='errorsList']/li[text()='{}']"