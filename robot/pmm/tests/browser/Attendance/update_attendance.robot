...
*** Test Cases ***
ATT10: Update attendance when service session status is Pending
...
ATT11: Update attendance when service session status is Complete
...
ATT12: Validate fields added to AttendanceServiceDeliveries Fieldset
    [Documentation]                 This test updates attendance for a service session record with Complete Status
