...
pmm_lex_locators = {
    ...
    "confirm": {
        ...
        "lookup_details": "//div[contains(@class, 'forcePageBlockItem') or contains(@class, 'slds-form-element_stacked')][.//span[text()='{}']]//descendant::div[.//span[contains(@class, 'test-id__field-value')]]//*[self::a]/descendant::span",
    },
    "new_record": {
        "label": "//div[./*/*[text()='{}']]",
    ...
    "related": {
        ...
        "new_record_link": "//div[@class='slds-grid']/a[contains(@class,'slds-truncate')]/descendant::span[contains(text(),'{}')]",
    ...
    "list_view": "//button[contains(@class,'slds-button') and @title='Select a List View']",
